...
During dormancy the landscape is traversable. Paths exist. Shade exists. The grinding is only a rumor underfoot. Visitors may walk the terraces, photograph the locked mouths, collect fallen “petals” that no longer bite, and stand at the overlooks without immediate incorporation.
...
The transition is not gradual. It begins with a single audible click that travels across the entire record.

Tourism Protocol (Dormant Only)
...
Major (rare in dormancy): a visitor stays past the click. The garden does not distinguish between guest and meal once bloom begins.
...
The galleries now display two linked exhibits: the sleeping terraces (safe to approach) and a time-locked bloom fragment (Observatory only).  

Request the dormant-cycle visitor pamphlet, the bloom-cycle quarantine contract, a map of the tourist paths, or the last evacuation log.
